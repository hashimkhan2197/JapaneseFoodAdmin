...
import 'package:japanesefoodappp/grocerry_kit/home_page.dart';
...
class _SignInPageState extends State<SignInPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scacffoldKey,
      body: Container(
        decoration: BoxDecoration(image: DecorationImage(image: AssetImage("images/japsignin.jpg"), fit: BoxFit.cover)),
        child: Align(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        style: TextStyle(fontSize: 20,color: Theme.of(context).accentColor,fontWeight: FontWeight.w400),
                        decoration: InputDecoration(
                          hintText: 'E-Mail Address',
                          errorStyle: TextStyle(fontSize: 16,),
                          enabledBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(8),
                              borderSide: BorderSide(color: Theme.of(context).buttonColor,width: 1.5)),
                          focusedBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(8),
                              borderSide: BorderSide(color: Theme.of(context).accentColor,width: 1.5)),
                        ),
                      ),
                    ),
                    Padding(
